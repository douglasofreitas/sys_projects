...
<?php echo $this->Form->create('Interacao'); ?>
	<fieldset>
		<legend><?php echo __('Edit Interacao'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Interacao.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Interacao.id'))); ?></li>
