...
<?php echo $this->Form->create('EmpresaConfig'); ?>
	<fieldset>
		<legend><?php echo __('Edit Empresa Config'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EmpresaConfig.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('EmpresaConfig.id'))); ?></li>
