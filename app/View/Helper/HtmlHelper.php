	...
	public function __construct(View $View, $settings = array()) {
		...
		if (!empty($settings['configFile'])) {
			$this->loadConfig($settings['configFile']);
                ...
                if (!empty($settings['empresa_chave'])) {
			$this->empresa = ($settings['empresa_chave']);
		}
	}
	...
	public function link($title, $url = null, $options = array(), $confirmMessage = false) {
		...
		if ($url !== null) {
			...
			$escapeTitle = false;
                ...
                if($url != '#'){
                    $url = str_replace('sysprojetos', 'sysprojetos/'.$this->empresa, $url);
                    $url = str_replace('grupodf/uploads', 'uploads', $url);
                }
