...
<?php echo $this->Form->create('ProjetoStatus'); ?>
	<fieldset>
		<legend><?php echo __('Edit Projeto Status'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ProjetoStatus.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('ProjetoStatus.id'))); ?></li>
