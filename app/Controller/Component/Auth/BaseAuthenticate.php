 ...
 */
	protected function _findUser($username, $password) {
		...
		$empresa_chave_url = str_replace('/users/login', '', $_SERVER['REQUEST_URI']);
		$empresa_chave_url = substr(strrchr($empresa_chave_url, '/'), 1 );
		...
		$conditions = array(
			...
			$model . '.' . 'empresa_chave_url' => $empresa_chave_url,
                        $model . '.' . 'ativo' => 1,
